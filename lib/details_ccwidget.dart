...
class DetailsCCWidget extends StatefulWidget {
  @override
  _MenuScreenState createState() => _MenuScreenState();
}

class _MenuScreenState extends State<DetailsCCWidget> {
                ...
                child: Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("Cash",style: TextStyle(color: AppColors.primaryText,fontWeight: FontWeight.bold),),
                      ...
                      Positioned(
                          top: 0.0,
                          child: Image(image: AssetImage("assets/images/indicator.png"),)),
                      Positioned(
                          top: 12.0,
                          right: 28.0,
                          child: Container(
